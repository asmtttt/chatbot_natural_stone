     ...
     function AvatarBrowser(formInput, sdkUser) {
         ...
         this.renderBrowser = function() {
             ...
             var html =
                     ...
                     + "<a href='#' onclick='AvatarBrowser.updateSearch()' title='Search'><img src='images/inspect.svg' style='width:40px;vertical-align: middle'></a></div>\n"
                     + "</div>\n"
                     + "<div id='" + this.prefix + "browser-div' class='" + this.prefix + "browser-div'>\n"
                     + "</div>\n";
             browser.innerHTML = html;
         ...
         this.fetchAvatar = function() {
             ...
             if(selectedBrowseOption){ browseType = selectedBrowseOption.value; };
 
             browseConfig.userFilter = (browseType == 'Private' || browseType == 'Personal') ? sdkUser : "all";
             browseConfig.typeFilter = browseType;
             browseConfig.contentRating = document.getElementById(this.prefix + 'browse-rating').value || "Everyone";
             var self = this;
             var urlprefix = self.sdk.credentials.url + "/";
